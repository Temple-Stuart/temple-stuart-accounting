...
export const PROJECT_DESIGN_EXEMPLAR = {
  ...
  problem_items: [
    'I HAVE NOT created an FSA ID yet (federalstudentaid.gov account required to file FAFSA)',
    'I HAVE NOT filed FAFSA 2026-2027',
    'I HAVE NOT submitted the Cal State LA admission application',
    'I HAVE NOT requested transcripts from prior institutions',
    'I HAVE NOT filed my 2025 personal tax return yet',
    'I HAVE NOT run private lender pre-qualifications (Sallie Mae, College Ave, Earnest)',
    'I HAVE NOT verified Cal State LA accounting bachelor\'s program total cost of attendance for 2026-2027',
    ...
    'I KEEP treating this project as standalone work and forgetting it depends on taxes + admission landing first',
  ],
  diagnosis_items: [
    'Because FAFSA pulls IRS income via the Data Retrieval Tool, it cannot run cleanly until the personal tax return is filed — the tax project is upstream, not parallel',
    'Because Schedule C and LLC pass-through income hit personal AGI, the business tax return must be filed before FAFSA so the household income picture is accurate',
    'The root cause is this project is downstream of "Taxes Personal" and "Sign up for Cal State LA" — treating it as standalone work hides those dependencies and inflates the schedule',
    'Because the FAFSA priority deadlines (March 2 at most CA schools) have already passed for 2026-2027, the aid pool is reduced and timing pressure is structural, not motivational',
    'The root cause of the May 9 target slipping is calendar-misanchoring: the real disbursement timeline is Cal State LA fall 2026 enrollment (August/September), not the aspirational date the user picked',
    'Because trading entity P&L plus LLC pass-through plus Schedule C plus capital gains create CPA-level disclosure complexity, FAFSA preparation is not a one-evening task — under-scoping the work is itself a cause of the gap',
  ],
  ...
  tasks_exemplar: [
    {
      ...
      notes: 'Do this first. FAFSA pulls income data from this return via the IRS Data Retrieval Tool. Without a filed return, FAFSA income fields must be entered manually, which slows verification and adds error risk. Filing electronically makes the data available to FAFSA in about two weeks.',
      suggested_order: 0,
    },
    {
    ...
    },
    {
      ...
      notes: 'Required for first-time federal loan borrowers. Returning borrowers — check Cal State LA financial aid office to confirm whether to repeat. Federal loan disbursement is blocked until this completes. Same FSA ID flow as the MPN.',
      suggested_order: 5,
    },
    {
      title: 'Confirm Fall 2026 enrollment with Cal State LA and pay enrollment deposit',
      description: 'After admission, confirm enrollment via the Cal State LA admit portal by the deadline on the admission letter. Most Fall admissions deadlines fall on May 1. Pay the non-refundable enrollment deposit. Deposit secures the seat — missing the deadline forfeits admission.',
      link_url: 'https://www.calstatela.edu/admissions/fall-2026-admission-deadlines-undergraduates',
      notes: 'Deadline is on the admission letter. Most Fall admissions deadlines fall on May 1. Deposit is non-refundable and forfeits the seat if missed. Confirm enrollment only after FAFSA disbursement and loan approval are locked, so the financial picture is real before committing.',
      suggested_order: 6,
    },
  ],
} as const;
