...
const FACTS: Readonly<Record<ToolName, ToolFacts>> = {
  ...
  Calendar: {
    ...
    links: [],
    citation: 'discover: src/components/hub/HubCalendar.tsx:166 (/api/calendar) · :182 (/api/operations/daily-plan/items) · :194 (/api/hub/operations-routines) — three GETs, the grid writes nothing · commit: src/components/hub/AddEventForm.tsx:247 → src/app/api/calendar/events/route.ts:75 (POST, INSERT INTO calendar_events) · :105 (PATCH) · :146 (DELETE) · record: src/components/hub/HubCalendar.tsx:173 (the rendered-source filter) · :330 (the grid refetches on save) · src/lib/calendar/sources.ts:78 (manual) · src/components/hub/DayView.tsx:221 (the hand-entered badge) · no decide: no persisted draft event',
