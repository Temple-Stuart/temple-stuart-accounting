...
// tools for the operator, not tools in the sheet. HYG-02: the two /dev checkout
// harnesses (disabled in production by their own headers) are deleted, not
// listed — a door on a dead page is compliance, not truth. ONE source for both headers
