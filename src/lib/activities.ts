...
export const ACTIVITY_SEARCH_EXPANSIONS: Record<string, { category: string; queries: string[] }[]> = {
  ...
  sports: [{ category: 'activities', queries: ['sports events stadium tours live sports tickets'] }],
  fashion: [{ category: 'activities', queries: ['fashion district designer boutiques fashion markets'] }],
  business: [{ category: 'coworking', queries: ['business networking events entrepreneur meetups startup hubs'] }],
  marketing: [{ category: 'coworking', queries: ['marketing conferences digital marketing events'] }],
  crypto: [{ category: 'coworking', queries: ['crypto meetups blockchain events web3 conferences'] }],
  accounting: [{ category: 'coworking', queries: ['finance conferences accounting networking'] }],
  dinner_shows: [{ category: 'nightlife', queries: ['dinner theater dinner shows cabaret dinner'] }],
  craft_workshop: [{ category: 'activities', queries: ['craft workshops artisan workshops pottery classes maker spaces'] }],
  pottery: [{ category: 'activities', queries: ['pottery classes ceramics workshops'] }],
  photography: [{ category: 'activities', queries: ['photography tours photo walks photography workshops instagram spots'] }],
  zoos: [{ category: 'activities', queries: ['zoo animal sanctuary wildlife park'] }],
  aquariums: [{ category: 'activities', queries: ['aquarium marine park oceanarium'] }],
  street_art: [{ category: 'activities', queries: ['street art tours graffiti tours murals urban art walks'] }],
  architecture: [{ category: 'activities', queries: ['architecture tours historic buildings architectural landmarks'] }],
  northern_lights: [{ category: 'activities', queries: ['northern lights tours aurora borealis viewing'] }],
  cherry_blossoms: [{ category: 'activities', queries: ['cherry blossom viewing spots hanami parks sakura festivals'] }],
  volcano: [{ category: 'activities', queries: ['volcano tours volcanic hikes crater tours'] }],
};
