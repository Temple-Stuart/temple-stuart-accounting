    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-6 text-text-secondary text-sm leading-relaxed">
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">1. Information We Collect</h2>
          ...
          <h3 className="text-md font-medium text-text-primary mt-4">Automatically Collected Information</h3>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">2. How We Use Your Information</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">3. Data Storage and Security</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">7. Your Rights</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">8. California Privacy Rights</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">9. Children's Privacy</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">10. Changes to This Policy</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">11. Contact Us</h2>
