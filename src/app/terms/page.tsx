    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-6 text-text-secondary text-sm leading-relaxed">
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">1. Description of Service</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">2. Account Registration</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">3. Subscription and Payments</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">4. Bank Account Integration</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">5. Not Financial Advice</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">6. Accuracy of Information</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">7. Acceptable Use</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">8. Intellectual Property</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">9. Disclaimer of Warranties</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">10. Limitation of Liability</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">11. Termination</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">12. Changes to Terms</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">13. Governing Law</h2>
          ...
          <h2 className="text-terminal-lg font-medium text-text-primary mt-8">14. Contact</h2>
          <p>For questions about these terms, contact us at astuart@templestuart.com.</p>
        </div>

        <div className="mt-12 pt-8 border-t border-border">
          <a href="/" className="text-sm text-brand-purple hover:underline">← Back to Home</a>
        </div>
      </div>
    </div>
  );
