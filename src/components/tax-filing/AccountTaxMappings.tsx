...
const SCHEDULE_C_LINES: Array<{ code: string; label: string; defaultMultiplier: number }> = [
  ...
  { code: '13', label: 'Depreciation', defaultMultiplier: 1.0 },
  { code: '15', label: 'Insurance', defaultMultiplier: 1.0 },
  { code: '16a', label: 'Interest (mortgage)', defaultMultiplier: 1.0 },
  { code: '16b', label: 'Interest (other)', defaultMultiplier: 1.0 },
  { code: '17', label: 'Legal & professional', defaultMultiplier: 1.0 },
