  ...
  return (
    ...
    <div className="min-h-screen bg-panel">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="max-w-3xl">
            ...
            {/* How it works — ONE shared, collapsible explainer for the active tab (projects /
                ...
                the headline button toggles them. Same text-white / text-text-faint tokens — no new
      ...
      {/* CPA Disclaimer — FD-3-2: the panel family, mirroring LandingFooter's
          CPA row (bg-panel + panel-border hairline; text-white/50). */}
      <section className="border-t border-panel-border bg-panel py-8">
      ...
      {/* Social — FD-3-2: the panel family, mirroring LandingFooter's social
          row (bg-panel + panel-border hairline; mono micro copyright;
          white/50 icon links). */}
      <section className="border-t border-panel-border bg-panel text-white py-8">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
