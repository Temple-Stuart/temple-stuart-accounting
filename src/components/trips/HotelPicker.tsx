            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-text-muted">
                    {hotel.cityName}
                    {/* HOTEL-01: a rating the option did not state is said so — never a blank star row. */}
                    <span className="ml-2">{hotel.rating ? renderStars(hotel.rating) : 'rating not stated by the property'}</span>
                  </div>
