    ...
    <>
      <section className="relative bg-gradient-to-b from-white to-gray-50 py-20 sm:py-28 lg:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Social Links - Black Oval Container */}
          <div className="inline-flex items-center gap-6 px-10 py-5 bg-gray-900 rounded-full shadow-2xl">
            <a href="https://instagram.com/templestuart" target="_blank" rel="noopener noreferrer" 
               className="text-white hover:text-[#b4b237] transition-colors">
